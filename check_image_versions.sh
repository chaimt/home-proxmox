...
images=(
    ...
    "duplicati/duplicati:2.3.0.0"
    "crazymax/diun:4.31.0"
    "amir20/dozzle:v10.3.3"
    ...
    "lscr.io/linuxserver/pairdrop:v1.11.2-ls135"
    "lscr.io/linuxserver/resilio-sync:3.1.2.1076-1-ls241"
    "b3log/siyuan:v3.6.4"
