...
def main():
    ...
    images = [
        ...
        ("mariadb", "12.3-ubi10"),
        ("n8nio/n8n", "2.25.1"),
        ("ollama/ollama", "0.30.0"),
        ("alpine/openclaw", "2026.5.27"),
        ("ghcr.io/open-webui/open-webui", "v0.9.6"),
        ("ghcr.io/speaches-ai/speaches", "0.9.0-rc.3-cpu"),
        ("lscr.io/linuxserver/speedtest-tracker", "1.14.3"),
