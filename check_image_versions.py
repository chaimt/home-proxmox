...
def main():
    ...
    images = [
        ("portainer/portainer-ce", "2.44.0-alpine"),
        ("nicolargo/glances", "4.5.6-full"),
        ("duplicati/duplicati", "2.3.0.4-stable"),
        ("crazymax/diun", "4.33.0"),
        ("amir20/dozzle", "v10.7.3-alpine"),
        ("headscale/headscale", "v0.29.3"),
        ("louislam/uptime-kuma", "2.5.0"),
        ("linuxserver/heimdall", "2.8.2"),
        ("ghcr.io/ajnart/homarr", "0.16.0"),
        ("lscr.io/linuxserver/pairdrop", "v1.11.2-ls143"),
        ("b3log/siyuan", "v3.8.1"),
        ("lscr.io/linuxserver/resilio-sync", "3.1.2.1076-1-ls255"),
        ("ghcr.io/mealie-recipes/mealie", "v3.19.2"),
        ("ghcr.io/linuxserver/swag", "5.6.0-ls462"),
        ("authelia/authelia", "4.39.20"),
        ("redis", "8.10-alpine3.23"),
        ("wallabag/wallabag", "2.6.14"),
        ("mariadb", "12.3-ubi10"),
        ("n8nio/n8n", "2.36.2-bc9090e"),
        ...
        ("lscr.io/linuxserver/speedtest-tracker", "1.14.8"),
